# -*- coding: utf-8 -*-
"""
Created on Fri Mar 30 21:32:21 2018
...
def canJump(A):
    ...
    for i in range(n):
        cur_max_ind = i+A[i]
        max_further_index = max(max_further_index,cur_max_ind)
        
        if max_further_index>=n-1:
            return 1
            
        if cur_max_ind == i and max_further_index==i:
            return 0
